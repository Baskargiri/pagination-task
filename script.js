var data=[
  ...
  function c_clicked(e){
    var a=document.querySelector('.btn').innerHTML;
    var for_no=parseInt(e.getAttribute('for')-1);
    var id_value=data[for_no].id;
    var name_v=data[for_no].name;
    var email_v=data[for_no].email;
...
for(i=1;i<=5;i++){
    ...
    if(attribute_val<=95){
    var inc_attribute_value=attribute_val+5;
    taking_for.setAttribute('for',inc_attribute_value)
    taking_for.innerText = inc_attribute_value;
    }
}
})
